    ...
    <Row>
      <Col class="bar">
        <Row type="flex" align="middle">
          ...
          <Col :xs="4" :md="4" :xl="4">
            <Button type="primary" @click="$router.push('/edit/new')">
      ...
      <Col>
        <Row ref="articleId" v-for="(item ,index) in data" :key="index" class="list" type="flex" align="middle">
          ...
          <Col :xs="4" :md="4" :xl="4">{{item.author}}</Col>
          <Col :xs="4" :md="4" :xl="4">
...
<script>
  import {getArticleList,dropArticle} from "../../api/aritcle";
